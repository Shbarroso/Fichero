...
public class UsuarioServiceModel extends Conexion {
    ...
    public UsuarioEntity obtenerUsuarioPorEmail(String email) {
        try {
            String sql = "SELECT * FROM Usuario " + "where email='"+email+"' or usuario='"+email+"'";
    ...
    public ArrayList<UsuarioEntity> obtenerUsuario(String sql) throws SQLException {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                UsuarioEntity usuarioModel = new UsuarioEntity(usuarioStr, nombreStr, contraseniaStr, emailStr);
